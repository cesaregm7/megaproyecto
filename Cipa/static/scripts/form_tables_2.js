if($('#nombre_formato').text() == 'Entrevista Telefónica'){
	var lista_dias_semana= ["Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sábado"];
	$.each( lista_dias_semana, function( i, l ){
		var j = i+1;
		$('#horario_table_first_col_'+j).text(l);
	});
}

if($('#nombre_formato').text() == 'Registro de Sesiones y Donativos'){
	var n = Number($("#filas_sesiones_donativos_table").val())+1;
	$('#sesiones_donativos_table > tbody:last-child').append('<tr id="last_line_sesiones"><td><input name="sesiones_donativos_table_col_'+n+'_1" type="text" class="form-control"/></td> <td><input name="sesiones_donativos_table_col_'+n+'_2" type="text" class="form-control"/></td><td><input name="sesiones_donativos_table_col_'+n+'_3" type="text" class="form-control"/></td><td><input name="sesiones_donativos_table_col_'+n+'_4" type="text" class="form-control"/></td><td><input name="sesiones_donativos_table_col_'+n+'_5" type="text" class="form-control"/></td><td><input name="sesiones_donativos_table_col_'+n+'_6" type="text" class="form-control"/></td><td><input name="sesiones_donativos_table_col_'+n+'_7" type="text" class="form-control"/></td></tr>');
	$("#filas_sesiones_donativos_table").val(n);
...
if($('#nombre_formato').text() == 'Historia Psicológica de Clientes Menores de Edad'){
	var n = Number($("#filas_relacion_personas_viven").val())+1;
	...
	$("#filas_relacion_personas_viven").val(n);
	...
	n = Number($("#filas_relacion_personas_familiares").val())+1;
	$('#relacion_personas_familiares > tbody:last-child').append('<tr id="last_line_personas_fuera"><td><input name="relacion_personas_familiares_col_'+n+'_1" type="text" class="form-control"/></td><td><input name="relacion_personas_familiares_col_'+n+'_2" type="text" class="form-control"/></td><td><input name="relacion_personas_familiares_col_'+n+'_3" type="text" class="form-control"/></td><td><input name="relacion_personas_familiares_col_'+n+'_4" type="text" class="form-control"/></td></tr>');
	$("#filas_relacion_personas_familiares").val(n);
	...
	$.each( lista_conductas_preescolares, function( i, l ){
		var j = i+1;
		$('#conductas_preescolar_first_col_'+j).text(l);
	});
	...
	$.each( lista_instituciones_educativas, function( i, l ){
		var j = i+1;
		$('#instituciones_educativas_first_col_'+j).text(l);
	});
	...
	$.each( lista_problemas_escolares, function( i, l ){
		var j = i+1;
		$('#problemas_escolares_first_col_'+j).text(l);
	});
	...
	$.each( lista_enfermedades_menor, function( i, l ){
		var j = i+1;
		$('#enfermedades_condiciones_menor_first_col_'+j).text(l);
	});
	...
	$.each( lista_enfermedades_familiar, function( i, l ){
		var j = i+1;
		$('#enfermedades_condiciones_familiar_first_col_'+j).text(l);
	});
	...
	$.each( lista_conducta_menor, function( i, l ){
		var j = i+1;
		$('#conductas_problemas_menor_first_col_'+j).text(l);
	});
	...
	$.each( lista_aspectos_padres, function( i, l ){
		var j = i+1;
		$('#aspectos_padres_poseen_first_col_'+j).text(l);
	});
	...
	$.each( lista_tecnica_disciplinaria, function( i, l ){
		var j = i+1;
		$('#tecnica_disciplinaria_usada_first_col_'+j).text(l)
	});
	
}
//-------
if($('#nombre_formato').text() == 'Información General de Cliente Adulto'){
	var n = Number($("#filas_familia_nuclear_adulto").val())+1;
	$('#familia_nuclear_adulto > tbody:last-child').append('<tr id="last_line_familia_adulto"><td><input name="familia_nuclear_adulto_'+n+'_1" type="text" class="form-control"/></td><td><input name="familia_nuclear_adulto_'+n+'_2" type="text" class="form-control"/></td><td><input name="familia_nuclear_adulto_'+n+'_3" type="text" class="form-control"/></td><td><input name="familia_nuclear_adulto_'+n+'_4" type="text" class="form-control"/></td></tr>');
	$("#filas_familia_nuclear_adulto").val(n);
	...
	$.each( lista_padecido_problemas, function( i, l ){
		var j = i+1;
		$('#familia_padecido_problemas_adulto_first_col_'+j).text(l);
	});
	...
	$.each( lista_padecimiento_adulto, function( i, l ){
		var j = i+1;
		$('#padecimiento_enfermedad_adulto_first_col_'+j).text(l);
	});
	
	
	n = Number($("#filas_medicamentos_tomando_adulto").val())+1;
	$('#medicamentos_tomando_adulto > tbody:last-child').append('<tr id="last_line_tomando_adulto"><td><input name="medicamentos_tomando_adulto_'+n+'_1" type="text" class="form-control"/></td><td><input name="medicamentos_tomando_adulto_'+n+'_2" type="text" class="form-control"/></td><td><input name="medicamentos_tomando_adulto_'+n+'_3" type="text" class="form-control"/></td></tr>');
	$("#filas_medicamentos_tomando_adulto").val(n);
	...
	n = Number($("#filas_info_consulta_recibida_adulto").val())+1;
	$('#info_consulta_recibida_adulto > tbody:last-child').append('<tr id="last_line_consulta_recibida_adulto"><td><input name="info_consulta_recibida_adulto_'+n+'_1" type="text" class="form-control"/></td><td><input name="info_consulta_recibida_adulto_'+n+'_2" type="text" class="form-control"/></td><td><input name="info_consulta_recibida_adulto_'+n+'_3" type="text" class="form-control"/></td></tr>');
	$("#filas_info_consulta_recibida_adulto").val(n);
	...
	$.each( lista_problemas_buscar, function( i, l ){
		var j = i+1;
		$('#problematica_buscar_adulto_first_col_'+j).text(l);
	});
	
	
	n = Number($("#filas_info_hospitalizacion_adulto").val())+1;
	$('#info_hospitalizacion_adulto > tbody:last-child').append('<tr id="last_line_hospitalizacion_adulto"><td><input name="info_hospitalizacion_adulto_'+n+'_1" type="text" class="form-control"/></td><td><input name="info_hospitalizacion_adulto_'+n+'_2" type="text" class="form-control"/></td><td><input name="info_hospitalizacion_adulto_'+n+'_3" type="text" class="form-control"/></td></tr>');
	$("#filas_info_hospitalizacion_adulto").val(n);
...
if($('#nombre_formato').text() == 'Notas de Sesión Inicial en Servicios Clínicos'){
	...
	$.each( lista_areas_disfuncionales, function( i, l ){
		var j = i+1;
		$('#areas_afectadas_first_col_'+j).text(l);
	});
	
	var n = Number($("#filas_objetivos_estrategias_tratamiento").val())+1;
	$('#objetivos_estrategias_tratamiento > tbody:last-child').append('<tr id="last_line_estrategias_tratamiento"><td><input name="objetivos_estrategias_tratamiento_'+n+'_1" type="text" class="form-control"/></td><td><input name="objetivos_estrategias_tratamiento_'+n+'_2" type="text" class="form-control"/></td></tr>');
	$("#filas_objetivos_estrategias_tratamiento").val(n);
...
if($('#nombre_formato').text() == 'Encuesta de Satisfacción del Cliente en Servicios Clínicos'){
	...
	$.each( lista_nivel_satisfaccion, function( i, l ){
		var j = i+1;
		$('#nivel_satisfaccion_first_col'+j).text(l);
	});
}
...
if($('#nombre_formato').text() == 'Encuesta de Satisfacción del Cliente en Servicios Psicoeducativos'){
	...
	$.each( lista_nivel_satisfaccion, function( i, l ){
		var j = i+1;
		$('#nivel_satisfaccionfirst_col'+j).text(l);
	});
}

if($('#nombre_formato').text() == 'Conceptualización de Caso'){
	
	var n = Number($("#filas_hijos_table").val())+1;
	$('#hijos_table > tbody:last-child').append('<tr id="last_line_hijos_table"><td><input name="hijos_table_'+n+'_1" type="text" class="form-control"/></td><td><input name="hijos_table_'+n+'_2" type="text" class="form-control"/></td><td><input name="hijos_table_'+n+'_3" type="text" class="form-control"/></td></tr>');
	$("#filas_hijos_table").val(n);
	...
	var n = Number($("#filas_familia_table").val())+1;
