...
class AuthUser(models.Model):
    image_uri = ImageField(upload_to='photos', blank=True, null=True)  
...
class Client(models.Model):
    ...
    client_user = models.ForeignKey(AuthUser, models.DO_NOTHING, blank=True, null=True)
...
class Comments(models.Model):
    ...
    def __str__(self):
		return '%s - %s' % (self.id_comments, self.message)
...
class Field(models.Model):
    ...
    field_identifier = models.CharField(max_length=100, blank=True, null=True)
    field_required = models.IntegerField(blank=True, null=True)
...
class FormTable(models.Model):
    ...
    form_table_name = models.TextField()
    field_number = models.IntegerField()
    form_type_id_form_type = models.ForeignKey('FormType', models.DO_NOTHING, db_column='form_type_id_form_type')
    field_type = models.IntegerField()
    ...
    column4 = models.TextField(blank=True, null=True)
    column5 = models.TextField(blank=True, null=True)
    column6 = models.TextField(blank=True, null=True)
    column7 = models.TextField(blank=True, null=True)
    form_table_identifier = models.CharField(max_length=100, blank=True, null=True)
...
class FormType(models.Model):
    ...
    visible_client = models.IntegerField(blank=True, null=True)
...
class Induction(models.Model):
    id_induction = models.AutoField(primary_key=True)
...
class SummaryForm(models.Model):
    id_summary_form = models.AutoField(primary_key=True)
    ...
    applied_tests = models.TextField()
    number_sessions = models.IntegerField()
    diagnosis = models.CharField(max_length=45)
    referred_by = models.CharField(max_length=45)
    record_id_record = models.ForeignKey(Record, models.DO_NOTHING, db_column='record_id_record')
    form_type_id_form_type = models.ForeignKey(FormType, models.DO_NOTHING, db_column='form_type_id_form_type')

    class Meta:
        managed = False
        db_table = 'summary_form'
...
class TestDemograficResult(models.Model):
    id_test_demografic_result = models.AutoField(primary_key=True)
    age = models.IntegerField()
...
class TestResult(models.Model):
    ...
    def __str__(self):
        return '%s %d' % ("id -", self.id_test_result)
...
class UserSkills(models.Model):
    ...
    emotional_skill = models.IntegerField(blank=True, null=True)
...
class Recomendation(models.Model):
    id_recomendation = models.AutoField(primary_key=True)
    text = models.TextField(blank=True, null=True)
    id_test_recomendation = models.ForeignKey('Test', models.DO_NOTHING, db_column='id_test_recomendation')

    class Meta:
        managed = False
        db_table = 'recomendation'
    def __str__(self):
        return '%d - %s' % (self.id_recomendation, self.id_test_recomendation)
